...
func newUniqueValueGenerator(valueGenerator Generator) Generator {
...
func (generator *uniqueValueGenerator) GenerateDataBySchema(ctx context.Context, schema *openapi3.Schema) (interface{}, error) {
	var data interface{}
	var err error
	var attempt int
