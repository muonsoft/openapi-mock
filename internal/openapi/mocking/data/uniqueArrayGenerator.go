...
func (generator *uniqueArrayGenerator) SetSchemaGenerator(schemaGenerator Generator) {
	generator.schemaGenerator = schemaGenerator
}

func (generator *uniqueArrayGenerator) GenerateDataBySchema(ctx context.Context, schema *openapi3.Schema) (interface{}, error) {
