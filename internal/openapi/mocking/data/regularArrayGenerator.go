...
func (generator *regularArrayGenerator) SetSchemaGenerator(schemaGenerator Generator) {
	generator.schemaGenerator = schemaGenerator
}

func (generator *regularArrayGenerator) GenerateDataBySchema(ctx context.Context, schema *openapi3.Schema) (interface{}, error) {
	var err error
