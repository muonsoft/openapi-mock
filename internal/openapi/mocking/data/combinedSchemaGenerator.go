...
func (generator *combinedSchemaGenerator) SetSchemaGenerator(schemaGenerator Generator) {
	generator.schemaGenerator = schemaGenerator
}

func (generator *combinedSchemaGenerator) GenerateDataBySchema(ctx context.Context, schema *openapi3.Schema) (interface{}, error) {
