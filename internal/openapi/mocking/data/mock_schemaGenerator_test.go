...
// mockSchemaGenerator is an autogenerated mock type for the Generator type
type mockSchemaGenerator struct {
	mock.Mock
}

// GenerateDataBySchema provides a mock function with given fields: ctx, schema
func (_m *mockSchemaGenerator) GenerateDataBySchema(ctx context.Context, schema *openapi3.Schema) (interface{}, error) {
